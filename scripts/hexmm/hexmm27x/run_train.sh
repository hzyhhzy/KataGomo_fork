...
do
    ...
    CUDA_VISIBLE_DEVICES="0,1" bash train.sh ../data b18c384n3 b18c384nbt-mish 128 main -multi-gpus 0,1 -samples-per-epoch 1000000
    ...
    CUDA_VISIBLE_DEVICES="0" bash export.sh hexmm27x ../data 0
    python view_loss.py
    cd ..
done
