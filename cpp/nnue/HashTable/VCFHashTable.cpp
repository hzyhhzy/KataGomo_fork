...
VCFHashTable_NNUE::VCFHashTable_NNUE(int sizePowerOfTwo, int mutexPoolSizePowerOfTwo) {
...
VCFHashTable_NNUE::~VCFHashTable_NNUE() {
  delete[] entries;
  delete mutexPool;
}

int64_t VCFHashTable_NNUE::get(Hash128 hash) {
...
void VCFHashTable_NNUE::set(Hash128 hash, int64_t result) {
